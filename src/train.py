...
def parse_args():
    ...
    parser.add_argument(
        '--output-data-dir', type=str, default=os.environ.get('SM_OUTPUT_DATA_DIR', None)
    )
    ...
    parser.add_argument('--valid', type=str, default=os.environ.get('SM_CHANNEL_VALID', None))
