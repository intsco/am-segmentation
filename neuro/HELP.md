...
|:--------------- |:----------- |:----------- |:-------------------------- | 
| `data/` | Data | `storage:neuro-tutorial/data/` | `/neuro-tutorial/data/` | 
| `modules/` | Python modules | `storage:neuro-tutorial/modules/` | `/neuro-tutorial/modules/` |
| `config/` | Configuration files | `storage:neuro-tutorial/config/` | `/neuro-tutorial/config/` |
| `notebooks/` | Jupyter notebooks | `storage:neuro-tutorial/notebooks/` | `/neuro-tutorial/notebooks/` |
| `results/` | Logs and results | `storage:neuro-tutorial/results/` | `/neuro-tutorial/results/` |
...
into `storage:neuro-tutorial/data` mounted to your development environment's `/project/data`.
